...
IMAGE_SIZE = (512, 512)  # Target image size for processing
SAM2_CHECKPOINT = f"{HOME}/checkpoints/sam2.1_hiera_base_plus.pt"
...
SAM_SCORE_THRESHOLD = 0.8  # Adjust as needed

# S3 bucket configuration
S3_BUCKET = 'treetracker-training-images'  # Replace with your bucket name
S3_SAMPLES_PREFIX = 'production_url_test/samples/'
S3_MASKS_PREFIX = 'production_url_test/binary_masks/'

# Async pipeline configuration
MAX_PREFETCH_BATCHES = 3  # Max number of batches to download in advance
DOWNLOAD_WORKERS = 8  # Number of download threads
...
def main():
    ...
    results_csv = "processing_results.csv"  # Path to save results CSV
